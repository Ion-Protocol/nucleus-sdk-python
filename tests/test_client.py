...
def test_manager_call():
    ...
    assert manager_call.client == client
    ...
    assert "calldata: ",manager_call.get_calldata().hex() == ""
...
def test_invalid_inputs():
    ...
    with pytest.raises(InvalidInputsError):
        ...
        manager_call.get_calldata()
    with pytest.raises(InvalidInputsError):
        manager_call = client.create_manager_call(root="0x8e93234bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="eth", symbol="Not_a_symbol")
        manager_call.get_calldata()
    with pytest.raises(APIError):
        manager_call = client.create_manager_call(root="0x0000034bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="eth", symbol="tETH")
        manager_call.get_calldata()
