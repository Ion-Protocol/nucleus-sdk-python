...
def get_valid_calldata_queue(client):
    calldata_queue = client.create_calldata_queue(root="0x8e93234bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="eth", symbol="tETH")
    return calldata_queue
...
def test_invalid_inputs():
    ...
    with pytest.raises(InvalidInputsError):
        calldata_queue = client.create_calldata_queue(root="0x8e93234bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="not_a_network", symbol="tETH")
        calldata_queue.get_calldata()
    with pytest.raises(InvalidInputsError):
        calldata_queue = client.create_calldata_queue(root="0x8e93234bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="eth", symbol="Not_a_symbol")
        calldata_queue.get_calldata()
    with pytest.raises(APIError):
        calldata_queue = client.create_calldata_queue(root="0x0000034bde5b9e369fb07acdee1cf6e3033222c2a4a0178fac08a05ce190d6e6", network_string="eth", symbol="tETH")
        calldata_queue.get_calldata()
...
def test_invalid_args():
 ...
 [["0xBA12222222228d8Ba445958a75a0704d566BF2C8",0],["0xC8Eb2Cf2f792F77AF0Cd9e203305a585E588179D",0],["0x1b81D678ffb9C0263b24A97847620C99d213eB14",0],["0x39F5b252dE249790fAEd0C2F05aBead56D2088e1",0],["0xDB74dfDD3BB46bE8Ce6C33dC9D82777BCFc3dEd5",0]]""")):
        calldata_queue.add_call("0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "approve(address,uint256)", ["0x00000fDD3BB46bE8Ce6C33dC9D82777BCFc3dEd5", 140], 0)
        calldata_queue.get_calldata()
